...
window.onload = function() {
  const dom: any = document.getElementsByClassName('link-name')[0].style
  // document.getElementsByClassName('link-name').style.display = 'none'
  console.log(document.getElementsByClassName('link-name')[0].style,dom, 'xxxxx')
