      ...
      <div>
        <el-form>
          <el-form-item>
            ...
            <el-form-grid >
              <ns-droptree ref="shopCateTree" :loading="loading" placeholder="请选择门店分类" :lazy="true" :load="loadShopAreaNode"  :multiple="false" v-model="departData.shopArea" clearable></ns-droptree>
            </el-form-grid>
