      ...
      'children': [
        {
          ...
          'name': 'ADD_PAGES',
          'title': '新增页面',
          'component': () => import('@/pages/ISV/addPages.vue')
        },
        {
          'path': '/operate/wechat/SgWxAccount',
          'name': 'SG_WXACCOUNT',
          'title': '授权管理',
          'component': () => import('@/pages/ISV/SgWxAccount/index.vue')
        }
      ]
    },
    {
      ...
      'children': [
        {
          ...
          'name': 'SQL_QUERY',
          'title': '数据查询',
          'component': () => import('@/pages/ISV/DataQuery/index.vue')
        }
      ]
    },
    {
      ...
      'children': [
        {
          ...
          'name': 'SYS_CONFIG',
          'title': '系统配置',
          'component': () => import('@/pages/ISV/SgSysConfig/index.vue')
        }
      ]
    },
    {
      ...
      'children': [
        {
          ...
          'title': '模板消息',
          'component': () => import('@/pages/ISV/SgAppletTemplate/index.vue')
        }
      ]
    },
    {
      ...
      'children': [
        {
          ...
          'name': 'CACHE_MANAGER',
          'title': '缓存管理',
          'component': () => import('@/pages/ISV/CacheManager/index.vue')
        }
      ]
    },
    {
      ...
      'children': [
        {
          ...
          'title': '联系我管理',
          'component': () => import('@/pages/ISV/SgEnterpriseContactWay/index.vue')
        }
      ]
    }
  ]
