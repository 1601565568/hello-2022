         ...
         <!-- 左边上角操作区域 -->
          ...
          <el-col :span="17">
            ...
            <div class="float-right tabSearchBtn">
              <ns-button @click="tabSearchType" style="padding: 9px 0 9px 10px;opacity: 0.5;color: #002041;" type="text">{{searchType.tipText}}<Icon :type="searchType.advanced ? 'up' : 'down'"/></ns-button>
            </div>
...
export default {
  ...
  methods: {
    ...
    async loadListFun (data) {
      ...
      await this.$http
        .fetch(this.$api.coupon.storeCoupon.queryStoreCouponList, searchObj)
        .then(resp => {
