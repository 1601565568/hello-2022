          ...
          <el-table
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                ...
                <ns-button type="text" v-if='scope.row.status!==1' @click='handleAnalysis(scope.row.guestCodeId)'>效果分析</ns-button>
              </template>
            </el-table-column>
          </el-table>
        </template>
...
Index.components = {
  PageTable, ElDrawer, PreviewPoster, ShopList, NsShopDialog
}
