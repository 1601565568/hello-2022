<template>
  <div>
    <NsTableShopGroup ref="mainTable" :url=$api.guide.guide.findList @add="onRedactFun" @scopeRowCount="scopeRowCount"
...
import NsTableShopGroupRobot from './NsTableShopGroupRobot'
List.components = {
