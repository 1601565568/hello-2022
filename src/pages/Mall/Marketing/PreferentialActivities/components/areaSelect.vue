      ...
      <el-row class="tmp-choose">
        <el-col :span="24">
          <div class="tmp-choose__title">
            <ns-button type="primary" @click="onShow"><Icon type="edit" /></ns-button>
            <span class="total">已选择<b class="text-danger padding-lr-base">{{confirmData.length}}</b>件商品</span></div>
        </el-col>
      </el-row>
    </div>
    <!-- 选择商品弹窗结构 -->
    <el-dialog title="包邮配送区域" :visible="visible" class="g-wrapper" width="960px" :show-scroll-x="false" append-to-body
