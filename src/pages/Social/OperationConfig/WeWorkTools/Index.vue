      ...
      <template slot='content'>
        ...
        <recruitment-collapse title='企微侧边栏设置' phoneTitle=''>
          <template slot='collapse-left'>
            <div class='step'>
              <div class='step-title'>1.设置网页授权的可信域名<ns-button type='text' class='lager-btn' @click='handleLocation("WEB_OPTION_URL")'>去配置</ns-button><ns-button type='text' class='lager-btn' @click='handleLocation("WEB_DESCRIBE_URL")' v-show="!$isQa || $qaDocs">配置说明</ns-button></div>
            ...
            <div class='step'>
              <div class='step-title'>2.上传校验域名文件<ns-button type='text' class='lager-btn' @click='handleLocation("FILE_OPTION_URL")'>去配置</ns-button><ns-button type='text' class='lager-btn' @click='handleLocation("FILE_DESCRIBE_URL")' v-show="!$isQa || $qaDocs">配置说明</ns-button></div>
              <div class='step-content'>
                <label >上传文件</label>
                <ElUpload
                  class="upload-demo"
            ...
            <div class='step'>
              <div class='step-title'>3.设置侧边栏功能<ns-button type='text' class='lager-btn' @click='handleLocation("SIDE_OPTION_URL")'>去配置</ns-button><ns-button type='text' class='lager-btn' @click='handleLocation("SIDE_DESCRIBE_URL")' v-show="!$isQa || $qaDocs">配置说明</ns-button></div>
        ...
        <recruitment-collapse title='好友自定义详情页' phoneTitle=''>
          <template slot='collapse-left'>
            <div class='step'>
              <div class='step-title'>设置自定义详情<ns-button type='text' class='lager-btn' @click='handleLocation("DIY_OPTION_URL")'>去配置</ns-button><ns-button type='text' class='lager-btn' @click='handleLocation("DIY_DESCRIBE_URL")' v-show="!$isQa || $qaDocs">配置说明</ns-button></div>
              <div class='step-content'>
