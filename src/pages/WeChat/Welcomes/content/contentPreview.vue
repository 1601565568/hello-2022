  ...
  <div class="message-exampleimg">
    ...
    <ElScrollbar>
      <div class="message-list">
        <div v-for="child in publishData" :key="child.id">
          <div class="message-msg">
            ...
            <!--视频 开始-->
            <div v-if="child.type === 'video'" class="message-item message-msg__uploader">
              <ElImage
                :height="73"
                :width="98"
                mode="mfit"
            ...
            <!--链接 开始-->
            <div class="message-web message-web--big"  v-if="child.type === 'link'">
              <div class="message-web__top">
                <div class="message-slogan">{{child.title}}</div>
                <div class="message-exhaustive">
                  <div class="message-exhaustive__leftside">{{child.description}}</div>
                  <ElImage
                    :width="34" :height="34"
                    :src="child.image"
            ...
            <!--小程序 开始-->
            <div class="message-web"  v-if="child.type === 'sendLittleProgram'">
              <div class="message-web__top">
