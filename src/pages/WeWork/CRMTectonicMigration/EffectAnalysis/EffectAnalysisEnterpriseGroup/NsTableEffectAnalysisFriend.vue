    ...
    <page-table :searchCol="24" :diyTitle="true">
      <template slot="title">
        <div class="head-router">
          <div>
            <span class="iconfont icon-icon-fanhuishangyiji icon-back" @click="$router.replace({ path: '/Marketing/EnterpriseGroupMessage' })"></span>
      ...
      <template slot='search'>
        <el-form :inline="true" class='form-inline_top'>
          <!-- <el-form-item label="">
            <el-input v-model.trim="model.searchValue" placeholder="微信群名" @keyup.enter.native="onSearch">
        ...
        <el-table ref="table" :data="_data._table.data" class="new-table_border"
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              {{scope.row.chatRoom && scope.row.chatRoom.name ? scope.row.chatRoom.name: '-'}}
            </template>
          </el-table-column>

          <el-table-column
            :show-overflow-tooltip="true"
            prop="chatRoom.ownerName"
            label="群主">
            <template slot-scope="scope">
              {{scope.row.chatRoom && scope.row.chatRoom.ownerName ? scope.row.chatRoom.ownerName: '-'}}
            </template>
          </el-table-column>

          <el-table-column
            :show-overflow-tooltip="true"
            prop="chatRoom.personNum"
            label="群人数">
            <template slot-scope="scope">
              {{scope.row.chatRoom && scope.row.chatRoom.personNum ? scope.row.chatRoom.personNum: '-'}}
            </template>
          </el-table-column>
  ...
  <!-- <ns-page-table> -->
    ...
    <!-- <template slot="table"> -->
      ...
      <!-- <el-table ref="table" :data="_data._table.data" class="template-table__main"
        ...
        <el-table-column :show-overflow-tooltip="true" type="default" prop="chatRoomsNick"
                         label="微信群名" align="left"
                         :sortable="false">
        </el-table-column>

        <el-table-column :show-overflow-tooltip="true" type="default" prop="empName"
                         label="群主" align="center"
                         :sortable="false">
        </el-table-column>
        <el-table-column :show-overflow-tooltip="true" type="default" prop="memberNum"
                         label="群人数" align="center"
                         :sortable="false">
        </el-table-column>
