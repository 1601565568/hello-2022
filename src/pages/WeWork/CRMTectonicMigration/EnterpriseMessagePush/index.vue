                ...
                <ElFormItem prop="textarea">
                  <ElFormGrid>
                    <el-input
                      ...
                      placeholder="请输入内容"
                      @blur="setView"
                      v-model="model.textarea" maxlength="400" style="width: 700px;">
                    </el-input>
                  </ElFormGrid>
                </ElFormItem>
                <ElFormItem>
...
export default {
  ...
  data () {
    return {
      ...
      isUpdate: false,
      loading: false,
      uploadPicUrl: this.$api.core.sgUploadFile('activityPic'),
      model: {
        id: '',
        name: '',
        marketingType: '',
  ...
  methods: {
    ...
    init () {
      ...
      if (this.$route.query.taskId) {
        this.$http.fetch(this.$api.marketing.wechat.getEnterpriseActivity, { taskId: this.$route.query.taskId })
          .then(resp => {
            ...
            if (data.content) {
              ...
              if (data.content.picText) {
                vm.pic = data.content.picText
                vm.model.type = 2
                vm.show = true
              }
              if (data.content.miniPro) {
    ...
    saveOrUpdate () {
      ...
      this.$http.fetch(this.$api.marketing.wechat.saveOrUpdateEnterprise, target)
        .then(() => {
