    ...
    <div class="template-page__row">
      ...
      <div class="template-page__row-right">
          <ns-page-table :colButton="0">
            ...
            <!-- 表格 -->
            <template slot="table">
              <div class="template-table__main-radio content-style">
                <el-radio-group v-model="radio">
                  <el-radio :label="1">销售趋势</el-radio>
                  <el-radio :label="2">关联商品</el-radio>
                  <el-radio :label="3">SKU分析</el-radio>
                  <el-radio :label="4">回购分析</el-radio>
                </el-radio-group>
              </div>
              <div class="template-table__main content-style">
                <div class="template-table__info">
                  当前商品：<span class="text-info">年货新品女式百搭翻领手工订珠 宽松冰丝棉透气纯色衬衫</span>，购买客户数：<span class="text-info">2</span>
                </div>
    ...
    .template-page__row-right {
      ...
      .template-table__main {
        ...
        .template-table__info {
          padding: var(--default-padding-base) var(--default-padding-larger) 0;
        }
      }
    }
