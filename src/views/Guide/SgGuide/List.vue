<template>
  <div>
    ...
    <el-dialog title="客户转移" :visible.sync="resignFormVisible" width="75%" v-if="transferCount!==null" :before-close="cancelTransferToResetByOne">
    ...
    <el-dialog :title="title"  :visible.sync="memberBelongingShow" width="460px" >
      ...
      <div v-if="storeOwnershipDisplay && memberBelongingRadio === '1'" class="guideBox" style="overflow-x:hidden;overflow-y:auto;">
        <el-select v-model="memberBelongingShopid" @change="changeMemberBelonging" placeholder="请选择要更换的门店">
