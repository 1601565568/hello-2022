<template>
  <div>
    <NsTableShopGroup ref="mainTable" :url=$api.guide.sgShopGroup.findList @add="onRedactFun" @scopeRowCount="scopeRowCount"
...
import NsTableShopGroup from './NsTableShopGroup'
List.components = {
  NsTableShopGroup,
  ElUpload
}
