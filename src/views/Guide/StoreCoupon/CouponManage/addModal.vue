      ...
      <div class="comDialogBoxCon" style="padding:0 0 20px 0;">
        <el-form
          ...
          <el-form-item label="优惠券名称：" prop="storeCouponTitle">
            <el-input type="text" class="comInput" maxlength=10 v-model="saveObj.storeCouponTitle"
                      placeholder="10个字以内"></el-input>
          </el-form-item>
          <el-form-item v-if="saveObj.storeCouponType===1" label="面额：" prop="storeCouponValue">
            <el-input class="comInput" v-model="saveObj.storeCouponValue" type="number"><span slot="append">元</span>
            </el-input>
          </el-form-item>
          <el-form-item v-if="saveObj.storeCouponType===2" label="折扣：" prop="storeCouponValue">
            <el-input class="comInput" v-model="saveObj.storeCouponValue" type="number"><span slot="append">折</span>
            </el-input>
          </el-form-item>
          <el-form-item class="is-required" v-if="saveObj.storeCouponType===3" prop="giftArr" label="兑换物品：">
          ...
          <el-form-item label="发行量：" required>
            <el-radio-group v-model="saveObj.issueAmountType">
              ...
              <el-form-item prop="maxIssueAmount">
                <el-radio :label="1">
                  <el-input style="width:120px" v-model="saveObj.maxIssueAmount" type="number">
          ...
          <el-form-item label="有效时间：" required>
            <el-form-grid>
              ...
              <el-form-item prop="couponTimeArr" v-if="saveObj.dateValidType===0">
                <el-date-picker
                  v-model="saveObj.couponTimeArr"
                  type="datetimerange"
                  range-separator="至"
              ...
              <el-form-item v-if="saveObj.dateValidType===1">
                ...
                <el-form-grid size="xmd">
                  <el-form-item prop="endDateTime">
                    <el-date-picker type="datetime" @change="couponEndTimeFun" placeholder="选择日期"
                                    v-model="saveObj.endDateTime"></el-date-picker>
                  </el-form-item>
                </el-form-grid>
              </el-form-item>
            </el-form-grid>
            ...
            <el-radio-group v-model="saveObj.useCondition.type">
                ...
                <el-radio :label="1">
                  ...
                  <el-form-grid size="xs">
                    <el-form-item prop="tradeAmount">
                      <el-input type="number" v-model="saveObj.useCondition.tradeAmount"><span slot="append">元</span>
                      </el-input>
                    </el-form-item>
                  </el-form-grid>
                  <el-form-grid>
                  ...
                  <el-form-grid size="xs">
                    <el-form-item prop="itemAmount">
                      <el-input type="number" v-model="saveObj.useCondition.itemAmount"><span slot="append">件</span>
                      </el-input>
                    </el-form-item>
                  </el-form-grid>
                </el-radio>
                ...
                <el-radio :label="2">
                  ...
                  <el-form-grid size="xs">
                    <el-form-item prop="itemCount">
                      <el-input type="number" v-model="saveObj.useCondition.itemCount"><span slot="append">件</span>
                      </el-input>
                    </el-form-item>
                  </el-form-grid>
              ...
              <el-form-item v-show="saveObj.storeCouponType === 3">
                <el-radio :label="3">
                  ...
                  <el-form-grid size="xs">
                    <el-form-item prop="itemCount">
                      <el-input v-model="saveObj.useCondition.addAmount" type="number"><span slot="append">元</span>
                      </el-input>
                      可用
                    </el-form-item>
                  </el-form-grid>
              ...
              <el-form-grid size="lg">
                <el-form-item prop="shopIds">
                  <ns-shop-select v-model="shopArr" :area="saveObj.area" :channel="saveObj.channel"
                                  :params="{isOnline: 0}"></ns-shop-select>
                </el-form-item>
              </el-form-grid>
              <Icon fontType="el-icon-info" v-if="$parent.careType === 'PayConcern'" className="text-tips">付款关怀仅支持线上店铺，不选则默认全部店铺</Icon>
